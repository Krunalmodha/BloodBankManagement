...
const logo = "/HemoCell Logo black.png";
						...
						<ul className="flex flex-col list-none md:flex-col md:min-w-full">
							<li className="items-center">
								<Link
									className={
										...
										(window.location.href.indexOf("/admin") !== -1 && window.location.href.indexOf("/admin/") === -1
							...
							<li className="items-center">
								<Link
									className={
										"text-[16px] py-3 font-bold block " +
										(window.location.href.indexOf("/donate-blood") !== -1
											? "text-red hover:text-dark_red"
											: "text-dark_gray hover:text-gray")
									}
							...
							<li className="items-center">
								<Link
									className={
										"text-[16px] py-3 font-bold block " +
										(window.location.href.indexOf("/need-blood") !== -1
											? "text-red hover:text-dark_red"
											: "text-dark_gray hover:text-gray")
									}
									to="/admin/need-blood"
							...
							<li className="items-center">
								<Link
									className={
										"text-[16px] py-3 font-bold block " +
										(window.location.href.indexOf("/host-blood-drive") !== -1
											? "text-red hover:text-dark_red"
											: "text-dark_gray hover:text-gray")
									}
							...
							<li className="items-center">
								<Link
									className={
										"text-[16px] py-3 font-bold block " +
										(window.location.href.indexOf("/need-help") !== -1
											? "text-red hover:text-dark_red"
											: "text-dark_gray hover:text-gray")
									}
									to="/admin/need-help"
